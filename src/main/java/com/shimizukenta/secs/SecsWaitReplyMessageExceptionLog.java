...
public class SecsWaitReplyMessageExceptionLog extends SecsThrowableLog {
	
	private static final long serialVersionUID = -4007928836031665906L;
	
	private final SecsWaitReplyMessageException cause;
	
	public SecsWaitReplyMessageExceptionLog(SecsWaitReplyMessageException cause) {
		super(cause);
		this.cause = cause;
	}
	
	public SecsWaitReplyMessageExceptionLog(SecsWaitReplyMessageException cause, LocalDateTime timestamp) {
